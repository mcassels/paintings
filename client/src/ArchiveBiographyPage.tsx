...
const PARAGRAPHS = [
  `James Gordaneer was an avid artist from childhood, but received little familial support for his work, and left high school after eighth grade to work in a local grocery store. At age 19, he had saved enough to enrol at the Doon School of Fine Arts near Kitchener, Ontario, where from 1952 to 1955 he studied plein air painting under artists including the Group of Seven’s Frederick Varley, Painters Eleven founder Jock MacDonald, and noted Canadian artists Carl Schaefer, Dorothy Stevens, Jack Bechtel, Alex Millar, and Yvonne Housser. The works of this period reflect those formative influences: explorations in figure and form rendered in a dark, gritty palette that captures figures in motion, the landscapes of southern Ontario, and the semi-industrial atmosphere of working-class Toronto. Following several years of travel and painting in Mexico and Europe, Gordaneer returned to Toronto to teach at Central Technical School before relocating to Orangeville, Ontario in 1962. Teaching in the local high school, he continued to exhibit in Toronto galleries while his work shifted toward broad abstractions, colourful palettes, and experimentation with white space in step with the decade's prevailing approaches to abstraction.`,
